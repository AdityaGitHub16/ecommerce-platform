package com.project.microservices.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute(){
        return route("product_service_swagger")
                .route(RequestPredicates.path("/aggregate/product-services/v3/api-docs"),HandlerFunctions.http())
                .before(uri("http://localhost:8080"))
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
        return route("order_service_swagger")
                .route(RequestPredicates.path("/aggregate/order-services/v3/api-docs"),HandlerFunctions.http())
                .before(uri("http://localhost:8081"))
                .before(setPath("/api-docs"))
    ...
    public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute(){
        return route("inventory_service_swagger")
                .route(RequestPredicates.path("/aggregate/inventory-services/v3/api-docs"),HandlerFunctions.http())
                .before(uri("http://localhost:8082"))
                .before(setPath("/api-docs"))
